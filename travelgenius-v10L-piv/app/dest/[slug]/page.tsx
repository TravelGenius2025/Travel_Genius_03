  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-3">
        <Link href={searchHref} className="button brand-gradient">Explore {c.name}</Link>
      ...
      <div className="text-sm text-[rgba(59,47,42,0.7)]">Pre-rendered for SEO. Add / edit cities in <code>lib/seoCities.ts</code>.</div>
    </div>
  )
}
